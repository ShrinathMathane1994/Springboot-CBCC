...
public class TestCaseController {
    ...
    public ResponseEntity<?> createTestCase(
        ...
        try {
            ...
            logger.info("Test case created with ID: {}", created.getId());
    ...
    public ResponseEntity<?> softDeleteTestCase(@PathVariable Long id) {
        logger.info("Deleting test case ID: {}", id);
        try {
            testCaseService.softDeleteTestCase(id);
            TestCase deleted = testCaseService.getTestCaseById(id);
            return ResponseEntity.ok(testCaseService.toResponseDTO(deleted)); // ✅ hides executionOn
        } catch (Exception e) {
    ...
    public ResponseEntity<List<TestCaseHistory>> getTestCaseHistory(@PathVariable Long id) {
        logger.info("Fetching history for test case ID: {}", id);
        return ResponseEntity.ok(testCaseService.getTestCaseHistory(id));
    }
